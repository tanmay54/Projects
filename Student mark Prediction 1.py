...
app = Flask(__name__)
model = joblib.load(r"C:\Users\tanma\OneDrive\Desktop\Data Science notes\December notes\Student Mark Predictor Project Deployment\Student mark Predictor Deployment\student_mark_predictor.pkl")
